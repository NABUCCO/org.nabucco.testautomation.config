...
public class Dependency extends NabuccoDatatype implements Datatype {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(Dependency.getPropertyDescriptor(ELEMENT), this.getElement(), null));
        properties.add(super.createProperty(Dependency.getPropertyDescriptor(ORDERINDEX), this.orderIndex, null));
        return properties;
    }
