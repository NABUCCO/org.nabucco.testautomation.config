...
/**
 * Dependency<p/>Container holding a TestConfigElement<p/>
 *
 * @version 1.0
 * @author sschmidt, PRODYNA AG, 2010-11-24
 */
public class Dependency extends NabuccoDatatype implements Datatype {
     ...
     * CloneObject.
     *
     * @param clone the Dependency.
     */
    protected void cloneObject(Dependency clone) {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(ELEMENT, PropertyDescriptorSupport.createDatatype(ELEMENT,
                TestConfigElement.class, 2, PROPERTY_CONSTRAINTS[0], false,
    ...
    public List<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(Dependency.getPropertyDescriptor(ELEMENT),
                this.element, null));
        properties.add(super.createProperty(Dependency.getPropertyDescriptor(ORDERINDEX),
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(Dependency.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(Dependency.class).getAllProperties();
    }
}
