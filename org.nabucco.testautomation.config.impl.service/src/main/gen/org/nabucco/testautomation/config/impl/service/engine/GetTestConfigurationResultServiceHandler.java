...
public abstract class GetTestConfigurationResultServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<TestResultMsg> invoke(ServiceRequest<TestInfoMsg> rq) throws TestEngineException {
     ...
     * @throws TestEngineException
     */
    protected abstract TestResultMsg getTestConfigurationResult(TestInfoMsg msg) throws TestEngineException;
