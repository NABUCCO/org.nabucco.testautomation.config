...
/**
 * ProduceTestConfigurationCloneServiceHandler<p/>Service to produce and clone TestConfigElements<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-15
 */
public abstract class ProduceTestConfigurationCloneServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.testautomation.config.impl.service.produce.ProduceTestConfigurationCloneServiceHandler";

    /** Constructs a new ProduceTestConfigurationCloneServiceHandler instance. */
    public ProduceTestConfigurationCloneServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<TestConfigurationMsg> invoke(ServiceRequest<TestConfigurationMsg> rq)
        ...
        try {
            ...
            msg = this.produceTestConfigurationClone(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws ProduceException
     */
    protected abstract TestConfigurationMsg produceTestConfigurationClone(TestConfigurationMsg msg)
            throws ProduceException;
