...
/**
 * ProduceTestScriptContainerServiceHandler<p/>Service to produce and clone TestConfigElements<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-15
 */
public abstract class ProduceTestScriptContainerServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<ProduceTestScriptContainerMsg> invoke(ServiceRequest<ProduceTestScriptContainerMsg> rq)
            throws ProduceException {
     ...
     * @throws ProduceException
     */
    protected abstract ProduceTestScriptContainerMsg produceTestScriptContainer(ProduceTestScriptContainerMsg msg)
            throws ProduceException;
