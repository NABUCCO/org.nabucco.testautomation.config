...
/**
 * ResolveTestConfigElementServiceHandler<p/>Config search service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-15
 */
public abstract class ResolveTestConfigElementServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.testautomation.config.impl.service.resolve.ResolveTestConfigElementServiceHandler";

    /** Constructs a new ResolveTestConfigElementServiceHandler instance. */
    public ResolveTestConfigElementServiceHandler() {
        super();
    }
     ...
     */
    protected ServiceResponse<TestConfigElementMsg> invoke(ServiceRequest<TestConfigElementSearchMsg> rq)
            throws ResolveException {
        ...
        try {
            ...
            msg = this.resolveTestConfigElement(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws ResolveException
     */
    protected abstract TestConfigElementMsg resolveTestConfigElement(TestConfigElementSearchMsg msg)
            throws ResolveException;
