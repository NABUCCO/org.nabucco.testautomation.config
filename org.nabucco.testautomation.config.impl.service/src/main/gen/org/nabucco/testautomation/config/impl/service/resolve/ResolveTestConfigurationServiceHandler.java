...
/**
 * ResolveTestConfigurationServiceHandler<p/>Config search service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-15
 */
public abstract class ResolveTestConfigurationServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.testautomation.config.impl.service.resolve.ResolveTestConfigurationServiceHandler";

    /** Constructs a new ResolveTestConfigurationServiceHandler instance. */
    public ResolveTestConfigurationServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<TestConfigurationListMsg> invoke(ServiceRequest<TestConfigurationSearchMsg> rq)
        ...
        try {
            ...
            msg = this.resolveTestConfiguration(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws ResolveException
     */
    protected abstract TestConfigurationListMsg resolveTestConfiguration(TestConfigurationSearchMsg msg)
            throws ResolveException;
