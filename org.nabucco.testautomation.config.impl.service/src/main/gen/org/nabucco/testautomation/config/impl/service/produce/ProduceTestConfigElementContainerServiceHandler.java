...
/**
 * ProduceTestConfigElementContainerServiceHandler<p/>Service to produce and clone TestConfigElements<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-15
 */
public abstract class ProduceTestConfigElementContainerServiceHandler extends PersistenceServiceHandlerSupport
     ...
     */
    protected ServiceResponse<TestConfigElementContainerMsg> invoke(ServiceRequest<TestConfigElementMsg> rq)
            throws ProduceException {
     ...
     * @throws ProduceException
     */
    protected abstract TestConfigElementContainerMsg produceTestConfigElementContainer(TestConfigElementMsg msg)
            throws ProduceException;
