 ...
 */
public abstract class CancelTestConfigurationServiceHandler extends ServiceHandlerSupport implements
        ServiceHandler {
     ...
     * @throws TestEngineException
     */
    protected abstract TestInfoMsg cancelTestConfiguration(TestInfoMsg msg)
            throws TestEngineException;
