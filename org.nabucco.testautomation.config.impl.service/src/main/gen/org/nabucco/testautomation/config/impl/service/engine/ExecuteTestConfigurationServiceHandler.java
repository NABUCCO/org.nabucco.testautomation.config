 ...
 */
public abstract class ExecuteTestConfigurationServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<TestInfoMsg> invoke(ServiceRequest<TestExecutionMsg> rq) throws TestEngineException {
     ...
     * @throws TestEngineException
     */
    protected abstract TestInfoMsg executeTestConfiguration(TestExecutionMsg msg) throws TestEngineException;
