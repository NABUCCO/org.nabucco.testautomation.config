...
/**
 * ReturnManualTestResultServiceHandler<p/>The Service to interact with a remote TestEngine<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-06-25
 */
public abstract class ReturnManualTestResultServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.testautomation.config.impl.service.engine.ReturnManualTestResultServiceHandler";

    /** Constructs a new ReturnManualTestResultServiceHandler instance. */
    public ReturnManualTestResultServiceHandler() {
        super();
    }
     ...
     */
    protected ServiceResponse<TestInfoMsg> invoke(ServiceRequest<ManualTestResultMsg> rq) throws TestEngineException {
        ServiceResponse<TestInfoMsg> rs;
        TestInfoMsg msg;
        try {
            this.validateRequest(rq);
            this.setContext(rq.getContext());
            msg = this.returnManualTestResult(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     *
     * @param msg the ManualTestResultMsg.
     * @return the TestInfoMsg.
     * @throws TestEngineException
     */
    protected abstract TestInfoMsg returnManualTestResult(ManualTestResultMsg msg) throws TestEngineException;
