 ...
 */
public abstract class ReturnManualTestResultServiceHandler extends ServiceHandlerSupport implements
        ServiceHandler {
     ...
     */
    protected ServiceResponse<TestInfoMsg> invoke(ServiceRequest<ManualTestResultMsg> rq)
            throws TestEngineException {
     ...
     * @throws TestEngineException
     */
    protected abstract TestInfoMsg returnManualTestResult(ManualTestResultMsg msg)
            throws TestEngineException;
