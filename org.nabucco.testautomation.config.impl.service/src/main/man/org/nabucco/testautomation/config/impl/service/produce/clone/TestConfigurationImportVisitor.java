...
/**
 * 
 * TestConfigurationImportVisitor
 * 
 * @author Steffen Schmidt, PRODYNA AG
 */
public class TestConfigurationImportVisitor extends
		TestConfigElementCloneVisitor {


	@Override
    protected void visit(TestConfigElement element) throws VisitorException {
    	// Import TestConfigElements cannot be reused
		element.setReused((Flag) null);
        super.visit(element);
    }
