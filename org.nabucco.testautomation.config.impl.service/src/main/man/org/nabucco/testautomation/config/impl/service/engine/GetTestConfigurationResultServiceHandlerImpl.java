 ...
 */
public class GetTestConfigurationResultServiceHandlerImpl extends GetTestConfigurationResultServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected TestResultMsg getTestConfigurationResult(TestInfoMsg msg) throws TestEngineException {
        ...
        try {
            ...
            try {
                ...
                this.getLogger().error(
                        "Could not request TestResult of Job "
                                + testExecutionInfo.getJobId().getValue() + " from TestEngine '", name, "' [", host,
                        ":", port, "]");
            ...
            if (result != null
                    && (result.getStatus() == TestConfigurationStatusType.FINISHED || result.getStatus() == TestConfigurationStatusType.CANCELLED)) {
