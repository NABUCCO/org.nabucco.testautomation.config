 ...
 */
public class GetTestStatusServiceHandlerImpl extends GetTestStatusServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected TestInfoMsg getTestStatus(TestInfoMsg msg) throws TestEngineException {
