...
/**
 * ImportConfigServiceHandlerImpl
 * 
 * @author Steffen Schmidt, PRODYNA AG
 */
public class ImportConfigServiceHandlerImpl extends
		ImportConfigServiceHandler {

	private static final long serialVersionUID = 1L;

	@Override
	protected ImportRs importConfig(ImportRq msg)
			throws ImportException {
		
		long start = System.currentTimeMillis();
		getLogger().info("Start importing Config ...");
        ...
        BasicImporter importer = new TestConfigurationImporter(this.getEntityManager(), importContext);
        importer.handleImport(container);
        getLogger().info("Finished importing of Config. Duration: " + (System.currentTimeMillis() - start) + " ms");
