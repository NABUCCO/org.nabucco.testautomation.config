...
public class TestConfigurationListMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(TestConfigurationListMsg.getPropertyDescriptor(TESTCONFIGLIST),
                this.testConfigList));
        return properties;
    }
    ...
    public int hashCode() {
        ...
        result = ((PRIME * result) + ((this.testConfigList == null) ? 0 : this.testConfigList.hashCode()));
        return result;
    }
    ...
    public NabuccoList<TestConfiguration> getTestConfigList() {
        if ((this.testConfigList == null)) {
            this.testConfigList = new NabuccoListImpl<TestConfiguration>(NabuccoCollectionState.INITIALIZED);
        }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(TestConfigurationListMsg.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(TestConfigurationListMsg.class).getAllProperties();
    }
}
