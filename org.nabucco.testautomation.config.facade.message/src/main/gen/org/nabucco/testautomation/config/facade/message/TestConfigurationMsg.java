...
public class TestConfigurationMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(TESTCONFIGURATION, PropertyDescriptorSupport.createDatatype(TESTCONFIGURATION,
                TestConfiguration.class, 0, PROPERTY_CONSTRAINTS[0], false, PropertyAssociationType.COMPOSITION));
        propertyMap.put(IMPORTCONFIG,
                PropertyDescriptorSupport.createBasetype(IMPORTCONFIG, Flag.class, 1, PROPERTY_CONSTRAINTS[1], false));
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(TestConfigurationMsg.getPropertyDescriptor(TESTCONFIGURATION),
                this.getTestConfiguration()));
        properties
                .add(super.createProperty(TestConfigurationMsg.getPropertyDescriptor(IMPORTCONFIG), this.importConfig));
        return properties;
    }
    ...
    public int hashCode() {
        ...
        result = ((PRIME * result) + ((this.importConfig == null) ? 0 : this.importConfig.hashCode()));
        return result;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(TestConfigurationMsg.class).getProperty(propertyName);
    }
