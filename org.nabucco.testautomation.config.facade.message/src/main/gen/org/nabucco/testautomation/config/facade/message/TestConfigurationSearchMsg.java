...
public class TestConfigurationSearchMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    private static final String[] PROPERTY_CONSTRAINTS = { "l3,12;m0,1;", "l0,n;m0,1;",
            "l0,255;m0,1;", "l0,255;m0,1;", "l0,n;m0,1;" };
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(LOADTESTSCRIPTS, PropertyDescriptorSupport.createBasetype(LOADTESTSCRIPTS,
                Flag.class, 4, PROPERTY_CONSTRAINTS[4], false));
    ...
    public List<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(
                TestConfigurationSearchMsg.getPropertyDescriptor(OWNER), this.owner));
        properties.add(super.createProperty(TestConfigurationSearchMsg.getPropertyDescriptor(ID),
                this.id));
        properties.add(super.createProperty(TestConfigurationSearchMsg.getPropertyDescriptor(NAME),
                this.name));
        properties.add(super.createProperty(
                TestConfigurationSearchMsg.getPropertyDescriptor(DESCRIPTION), this.description));
        properties.add(super.createProperty(
                TestConfigurationSearchMsg.getPropertyDescriptor(LOADTESTSCRIPTS),
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(TestConfigurationSearchMsg.class)
