...
/**
 * TestConfigListViewWidgetFactory<p/>ListView for Test Configuration<p/>
 *
 * @author Stefan Huettenrauch, PRODYNA AG, 2010-05-25
 */
public class TestConfigListViewWidgetFactory extends WidgetFactory {

    /**
     * Constructs a new TestConfigListViewWidgetFactory instance.
     *
     * @param nabuccoFormToolKit the NabuccoFormToolkit.
     */
    public TestConfigListViewWidgetFactory(NabuccoFormToolkit nabuccoFormToolKit) {
