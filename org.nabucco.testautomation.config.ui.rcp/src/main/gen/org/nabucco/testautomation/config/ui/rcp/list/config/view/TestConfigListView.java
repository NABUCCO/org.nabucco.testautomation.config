...
/**
 * TestConfigListView<p/>ListView for Test Configuration<p/>
 *
 * @author Stefan Huettenrauch, PRODYNA AG, 2010-05-25
 */
public class TestConfigListView extends NabuccoComponentListView {
    ...
    /** Constructs a new TestConfigListView instance. */
    public TestConfigListView() {
        super();
        model = new TestConfigListViewModel();
    }
