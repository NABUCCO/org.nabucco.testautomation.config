 ...
 */
package org.nabucco.testautomation.config.ui.rcp.communication.report;
...
public class ReportConfigDelegate extends ServiceDelegateSupport {
    ...
    public DashboardStatisticMsg getDashboardStatistic(EmptyServiceMessage message, ServiceSubContext... subContexts)
        ...
        throw new ClientException("Cannot execute service operation: ReportConfig.getDashboardStatistic");
    }
}
