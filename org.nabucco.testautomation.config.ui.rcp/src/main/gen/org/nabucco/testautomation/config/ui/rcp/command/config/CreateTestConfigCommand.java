...
public class CreateTestConfigCommand implements NabuccoCommand {
    ...
    private CreateTestConfigCommandHandler createTestConfigCommandHandler = NabuccoInjector.getInstance(
            CreateTestConfigCommand.class).inject(CreateTestConfigCommandHandler.class);
