...
/**
 * TestConfigListViewTestConfigurationNameComparator
 *
 * @author Undefined
 */
public class TestConfigListViewTestConfigurationNameComparator extends
        NabuccoColumComparator<TestConfiguration> {

    /** Constructs a new TestConfigListViewTestConfigurationNameComparator instance. */
    public TestConfigListViewTestConfigurationNameComparator() {
        super();
    }
