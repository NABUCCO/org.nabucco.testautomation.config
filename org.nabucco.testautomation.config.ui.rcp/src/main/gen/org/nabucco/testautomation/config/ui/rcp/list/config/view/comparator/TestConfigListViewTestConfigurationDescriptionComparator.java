...
/**
 * TestConfigListViewTestConfigurationDescriptionComparator
 *
 * @author Undefined
 */
public class TestConfigListViewTestConfigurationDescriptionComparator extends
        NabuccoColumComparator<TestConfiguration> {

    /** Constructs a new TestConfigListViewTestConfigurationDescriptionComparator instance. */
    public TestConfigListViewTestConfigurationDescriptionComparator() {
        super();
    }
