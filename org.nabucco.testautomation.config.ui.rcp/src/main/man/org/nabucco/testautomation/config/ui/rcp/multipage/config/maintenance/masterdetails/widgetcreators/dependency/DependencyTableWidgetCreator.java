...
import org.nabucco.testautomation.config.ui.rcp.multipage.config.maintenance.masterdetails.widgetcreators.dependency.listeners.RemoveListener;
import org.nabucco.testautomation.config.ui.rcp.multipage.config.maintenance.masterdetails.widgetcreators.dependency.listeners.TestConfigElementTreePickerDialogListener;
...
public class DependencyTableWidgetCreator extends
	...
	private static final String ID = "org.nabucco.testautomation.config.ui.rcp.multipage.config.maintenance.masterdetails.widgetcreators.script.DependencyTable";
	...
	private TablePickerComposite<TreePickerDialog> createTreeDialogPickerTable(
		...
		return new TablePickerComposite<TreePickerDialog>(parent, SWT.NONE
				...
				| TablePickerComposite.REMOVE_BUTTON
				| TablePickerComposite.REPLACE_BUTTON, 150, outerTableParameter,
	...
	private TablePickerListener createListeners(DependencyTableMiniModel model) {
		...
		return new TablePickerListener(null, removeListener, null, null, null);
	}
