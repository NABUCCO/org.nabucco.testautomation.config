 ...
 */
public class TestConfigDetailPageView extends
        PropertyDetailPageView<TestConfigurationMaintenanceMultiPageEditViewModel> {

    /**
     * Creates a new {@link TestConfigDetailPageView} instance.
     * 
     * @param block
     ...
     */
    public TestConfigDetailPageView(MasterDetailBlock<TestConfigurationMaintenanceMultiPageEditViewModel> block,
            IManagedForm managedForm,
            ManagedFormViewPart<TestConfigurationMaintenanceMultiPageEditViewModel> parentView,
            NabuccoMessageManager messageManager, String masterId, String title, Set<String> invisibleProperties,
            Set<String> readOnlyProperties) {
        super(block, managedForm, parentView, messageManager, masterId, title, invisibleProperties, readOnlyProperties);
    }

    @Override
    protected GeneralDetailPageViewLayouter getLayouter(String detailTitle) {
        return new TestConfigDetailPageViewLayouter(detailTitle);
    }
