...
public class TestConfigurationEditViewBrowserHandlerImpl implements
    ...
    @Override
    public void createChildren(TestConfigurationMaintenanceMultiPageEditViewModel viewModel,
            TestConfigurationEditViewBrowserElement element) {
        // do nothing. TestConfigElement won�t be displayed in the BrowserView
    }

    @Override
    public TestConfigurationMaintenanceMultiPageEditViewModel loadFull(
            TestConfigurationMaintenanceMultiPageEditViewModel testConfiguration) {
