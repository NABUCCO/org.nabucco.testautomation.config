...
/**
 * TestConfigurationMaintenanceMultiPageAddDialogKeyLabelProvider
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class TestConfigurationMaintenanceMultiPageAddDialogKeyLabelProvider extends AddDialogLabelProvider {

    @Override
    public String getText(final Object obj) {
        if (obj instanceof TestConfigElementContainer) {
            TestConfigElement element = ((TestConfigElementContainer) obj).getElement();
            return element.getIdentificationKey().getValue();
        } else if (obj instanceof PropertyContainer) {
            Property property = ((PropertyContainer) obj).getProperty();
            return property.getIdentificationKey().getValue();
