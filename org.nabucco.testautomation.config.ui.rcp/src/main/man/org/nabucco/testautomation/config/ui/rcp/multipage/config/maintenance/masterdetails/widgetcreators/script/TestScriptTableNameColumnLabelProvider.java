 ...
 */
public class TestScriptTableNameColumnLabelProvider implements ILabelProvider {
    ...
    private String labelScriptContainer(TestScriptContainer container) {
        if (container.getTestScript() != null
                && container.getTestScript().getName() != null) {
            return container.getTestScript().getName().getValue();
        }
        return "";
    }
    ...
    private String labelScript(TestScript script) {
        if (script.getName() != null && script.getName().getValue() != null) {
