 ...
 */
public class TestConfigurationMaintainanceMasterDetailTreeNodeCreator extends
    ...
    public MasterDetailTreeNode createNodeTyped(final Datatype dataType,
        ...
        if (dataType instanceof TestConfiguration) {
            ...
            for (TestConfigElementContainer testConfigElementContainer : testScript
                    .getTestConfigElementList()) {
                MasterDetailTreeNode child = MasterDetailTreeNodeCreatorForAllDatatypes
                        .getInstance().create(testConfigElementContainer.getElement(), result);
            ...
            if (testConfigElementParent.getPropertyList() != null) {
                MasterDetailTreeNode child = MasterDetailTreeNodeCreatorForAllDatatypes
                        .getInstance().create(testConfigElementParent.getPropertyList(), result);
