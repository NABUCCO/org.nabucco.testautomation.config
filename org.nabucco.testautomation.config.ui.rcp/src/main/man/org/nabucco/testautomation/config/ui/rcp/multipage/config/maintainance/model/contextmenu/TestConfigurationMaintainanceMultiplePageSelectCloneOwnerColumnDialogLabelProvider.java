...
/**
 * TestConfigurationMaintainanceMultiplePageSelectCloneOwnerColumnDialogLabelProvider
 * 
 * @author Markus Jorroch, PRODYNA AG
 */
public class TestConfigurationMaintainanceMultiplePageSelectCloneOwnerColumnDialogLabelProvider extends
    ...
    public String getText(final Object obj) {
        ...
        if (obj instanceof TestConfigElementContainer) {
            ...
            if (datatypeState != DatatypeState.INITIALIZED) {
                String owner = element.getOwner().getValue();
                result = owner;
            } else {
                result = "";
            }
