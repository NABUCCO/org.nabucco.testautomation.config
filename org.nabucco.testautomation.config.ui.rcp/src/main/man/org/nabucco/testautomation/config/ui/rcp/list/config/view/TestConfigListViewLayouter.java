...
public class TestConfigListViewLayouter extends NabuccoAbstractListLayouter<TestConfigListViewModel> {
    ...
    public NabuccoTableViewer layout(final Composite parent, final NabuccoMessageManager messageManager,
            final TestConfigListViewModel model, final Layoutable<TestConfigListViewModel> view) {
        ...
        NabuccoTableParameter parameter = new NabuccoTableParameter(new NabuccoDefaultTableSorter<TestConfiguration>(
                createComparators()), new TestConfigListViewTableFilter(),
    ...
    private NabuccoTableColumnInfo[] createTableColumnInfo() {
        NabuccoTableColumnInfo col1 = new NabuccoTableColumnInfo(KEY_COLUMN_KEY, KEY_COLUMN_KEY, 150, SWT.LEFT,
                SWT.CENTER, new TestConfigurationListViewTestConfigurationKeyLabelProvider());

        col1.setHidable(false);

        NabuccoTableColumnInfo col2 = new NabuccoTableColumnInfo(NAME_COLUMN_KEY, NAME_COLUMN_KEY, 400, SWT.LEFT,
                SWT.CENTER, new TestConfigurationListViewTestConfigurationNameLabelProvider());
        ...
        NabuccoTableColumnInfo col3 = new NabuccoTableColumnInfo(DESCRIPTION_COLUMN_KEY, DESCRIPTION_COLUMN_KEY, 400,
                SWT.LEFT, SWT.LEFT, new TestConfigurationListViewTestConfigurationDescriptionLabelProvider());
