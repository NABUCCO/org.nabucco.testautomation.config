...
public class SaveTestConfigHandlerImpl
        extends
        AbstractSaveCommandHandlerImpl<TestConfigurationEditViewBusinessModel, TestConfigurationMaintenanceMultiPageEditViewModel>
    ...
    @Override
    protected void saveModel(TestConfigurationMaintenanceMultiPageEditViewModel viewModel,
        ...
        HistoryEntry entry = new HistoryEntry(HistoryEntryType.TEST_CONFIGURATION, new Identifier(
                response.getId()), response.getIdentificationKey(), response.getName(), response.getDescription());
